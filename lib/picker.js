...
var Picker = _react2.default.createClass({
  ...
  propTypes: {
    ...
    strategy: _react2.default.PropTypes.objectOf(_react2.default.PropTypes.shape({
      unicode: _react2.default.PropTypes.string,
      unicode_alternates: _react2.default.PropTypes.string,
      name: _react2.default.PropTypes.string,
      shortname: _react2.default.PropTypes.string,
      category: _react2.default.PropTypes.string,
      emoji_order: _react2.default.PropTypes.string,
      aliases: _react2.default.PropTypes.array,
      aliases_ascii: _react2.default.PropTypes.array,
      keywords: _react2.default.PropTypes.array
    })),
    recentlyUsedShortnames: _react2.default.PropTypes.arrayOf(_react2.default.PropTypes.string)
  },
  ...
  emojisFromStrategy: function emojisFromStrategy(strategy) {
    ...
    emojis.recentlyUsed = this.props.recentlyUsedShortnames.reduce(function (ret, shortname) {
      var key = (0, _findKey2.default)(strategy, function (d) {
        return d.shortname === shortname;
      });
      return _extends({}, ret, _defineProperty({}, key, [strategy[key]]));
    }, {});
  ...
  updateActiveCategory: (0, _throttle2.default)(function () {
    ...
    var padding = 10;
    var selected = this.hasRecentlyUsed() ? 'recentlyUsed' : 'people';
  ...
  renderCategories: function renderCategories() {
    ...
    var recentlyUsed = _props$categories.recentlyUsed;

    var c = _objectWithoutProperties(_props$categories, ['recentlyUsed']);

    var categories = this.hasRecentlyUsed() ? _extends({ recentlyUsed: recentlyUsed }, c) : c;

    (0, _each2.default)(categories, function (details, key) {
  ...
  hasRecentlyUsed: function hasRecentlyUsed() {
